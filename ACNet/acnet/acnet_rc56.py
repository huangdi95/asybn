...
from constants import parse_usual_lr_schedule
...
def acnet_rc56():
    ...
    if 'normal' in try_arg:
        builder = None
    elif 'hdacnet' in try_arg:
        from acnet.hdacnet_builder import HDACNetBuilder
        builder = HDACNetBuilder(base_config=config, deploy=False)
